...
import { image_profile_girl, image_exotic, image_jirachi_high, image_two_demons } from '../Data/galleries';

const galleryItems = [
    { id: 1, image_source: image_profile_girl, description: 'ILLUSTRATIONS', link: '/gallery/illustrations' },
